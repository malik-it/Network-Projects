...
|---|---|---|
| PC3 → PC1 (`ping 172.16.1.1`) | Fail | ![PC3 to PC1](Screenshots/ping-pc3-pc1.png) |

### Policy 2 — 172.16.1.0/24 can't access DNS on SRV1

| Test | Expected Result | Evidence |
|---|---|---|
| PC1 → SRV1, `nslookup 192.168.1.100` | Fail | ![PC1 DNS to SRV1](Screenshots/dns-pc1-srv1.png) |
| PC1 → SRV1, `ping 192.168.1.100` | Success — only DNS is blocked, not the host | ![Ping PC1 to SRV1](Screenshots/ping-pc1-srv1.png) |

**`nslookup 192.168.1.100` output:**
```
...
| Test | Expected Result | Evidence |
|---|---|---|
| PC3 → SRV2, browser to `http://192.168.2.100` | Fail | ![PC3 HTTP to SRV2](Screenshots/http-pc3-srv2.png) |

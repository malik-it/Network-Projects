...
EUI-64 builds the 64-bit interface ID from the interface's 48-bit MAC address by splitting it, inserting `FFFE` in the middle, and flipping the 7th bit (the U/L bit) of the first byte. Worked out for each router's G0/1 MAC address (derived from the resulting EUI-64 addresses shown in `show ipv6 interface brief`):

**R1 — G0/1 (MAC `0030.F236.4502`)**

1. Split the MAC address in half: `0030.F2 | 36.4502`
2. Insert `FFFE` in the middle: `0030:F2FF:FE36:4502`
3. Flip the 7th bit of the first byte: `00` → `02`
4. Append the result after the /64 prefix: `2001:DB8::230:F2FF:FE36:4502/64`

**R2 — G0/1 (MAC `0001.63B0.B802`)**

1. Split the MAC address in half: `0001.63 | B0.B802`
2. Insert `FFFE` in the middle: `0001:63FF:FEB0:B802`
3. Flip the 7th bit of the first byte: `00` → `02`
4. Append the result after the /64 prefix: `2001:DB8:0:1:201:63FF:FEB0:B802/64`
